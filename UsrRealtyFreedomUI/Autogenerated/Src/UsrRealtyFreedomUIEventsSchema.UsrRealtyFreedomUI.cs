namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyFreedomUIEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("b4032f4c-5dab-4ee6-9795-8020a57f4f68");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("8f69af8d-fbdc-374f-98e4-f01aa4cf9c18"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("fe4fb29c-640c-4519-9585-e4d86a81f8fb"),
				CreatedInSchemaUId = new Guid("b4032f4c-5dab-4ee6-9795-8020a57f4f68"),
				ModifiedInSchemaUId = new Guid("b4032f4c-5dab-4ee6-9795-8020a57f4f68")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("b4032f4c-5dab-4ee6-9795-8020a57f4f68"));
		}
