define("UsrRealtyClassic1Page", [], function() {
	return {
		...
		businessRules: /**SCHEMA_BUSINESS_RULES*/{
			"UsrComment": {
				"789a83f0-2e39-417a-9d34-a1cc21497cab": {
					"uId": "789a83f0-2e39-417a-9d34-a1cc21497cab",
					"enabled": true,
					"removed": false,
					"ruleType": 0,
					"property": 2,
		...
		methods: {
			calculateCommission: function() {
				...
				var percent = 0;
				if (offerTypeObject) {
					percent = offerTypeObject.UsrPercent;
				}
			...
			onMyButtonClick: function() {
				this.console.log("PUSH IT!");
				var price = this.get("UsrPriceUSD");
				this.console.log("Price = " + price);
				this.set("UsrArea", 2000);
			},
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName5266b946-06dd-4e4e-8146-5b9aaadd4e1b",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT300faade-d359-4871-aea6-7f7a2041418a",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT4c090165-585a-4eaa-ba62-74888a0c94c9",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT1f3fdb1f-6053-46de-9487-e92b798f1b76",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP93ff15b0-c1ec-41bc-af42-e82aa39cd49d",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPdb551704-d3cc-49d5-b7c1-20af79b865f3",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING0ff60c7e-75c3-431f-bcdc-275f17932867",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPcd3bdc48-7fd4-47db-9c7f-172cfe4b6c74",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
